...
\only<4->{
\begin{itemize}
\uncover<3->{\item Algoritmos conservadores}
\uncover<3->{\item \textbf{Algoritmos optimistas}}
\uncover<3->{\item Algoritmos totalmente desincronizados}
\end{itemize}
}
...
procesador lógico (LP) diferente.

En cada paso de simulación, el LP chequa si la variable que cambió se debe informar a los demás LPs.
...
\begin{frame}{Simulación en Paralelo de Sistemas de Eventos Discretos}{Comunicación entre procesos}

Es un proceso híbrido:
...
\begin{frame}{Simulación en Paralelo de Sistemas de Eventos Discretos}{Partición del Modelo}
